				...
				<tr>
					...
					<td>
						<form method="post">
							...
							<button class="btn btn-danger" id="btnCancel" type="submit"
								name="cancel" value="${userAttemptRegistration.attempt.status}">Cancel</button>
						</form>
					</td>
					<td>
						<form method="post">
							<button class="btn btn-primary" id="btnSignup" type="submit"
								disabled="disabled" name="signup"
								value="${userAttemptRegistration.status}">Signup</button>
						</form>
					</td>
				</tr>
			</c:forEach>
